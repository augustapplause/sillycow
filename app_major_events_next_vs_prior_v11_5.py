...
def render_major_events_section(profile, key_prefix="main"):
    ...
    events = df.dropna(subset=["Dollar_Change_Event_Window", "Percent_Change_Event_Window"] + metric_cols).copy()
    ...
    with right:
        ...
        st.caption(
            f"Current state plus {event_count} major events where next-day close versus prior-day close moved +/- {threshold_pct}% or greater. "
